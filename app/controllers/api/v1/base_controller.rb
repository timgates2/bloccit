...
rescue_from ActionController::ParameterMissing, with: :malformed_request
  ...
  def malformed_request
    render json: {error: "The request could not be understood by ther server due to malformed syntax. The client SHOULD NOT repeat the request without modifications.", status: 400}, status: 400
  end
